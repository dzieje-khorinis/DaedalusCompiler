...
namespace Common.SemanticAnalysis
{
    ...
    {
	    private int _sourceFileNumber;
	    private List<InheritanceParentReferenceNode> _inheritanceReferenceNodes;
	   
	    public List<ReferenceNode> ReferenceNodes { get; private set; }
	    private List<ConstDefinitionNode> _constDefinitionNodes;
	    private List<IArrayDeclarationNode> _arrayDeclarationNodes;
	    
	    public void Reset(int sourceFileNumber)
	    {
